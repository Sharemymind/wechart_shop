...
import cn.zhangkai.goods.utils.FileUtil;
...
public class FastdfsController {
    ...
    public ApiJSONResult uploadFileAndUserId(@ApiParam(value = "上传的文件", required = true) MultipartFile file, String userId) throws Exception {
        /* 设置文件信息 */
    ...
    public ApiJSONResult uploadFaceBase64(String base64, String userId) throws Exception {
     ...
     */
    private ApiJSONResult getApiJSONResultByImg(String userId, String path) {
        UserInfo user = new UserInfo();
        //user.setAvatarUrl("http://39.108.13.196:88/zxh/" + path);
        user.setId(userId);
        basicController.userInfoService.updateUserInfo(user);
